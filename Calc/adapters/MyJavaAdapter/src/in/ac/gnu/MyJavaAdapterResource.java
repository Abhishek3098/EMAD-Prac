...
@Path("/users")
public class MyJavaAdapterResource {
	/*
	 * For more info on JAX-RS see https://jsr311.java.net/nonav/releases/1.1/index.html
	 */
		
	//Define logger (Standard java.util.Logger)
	static Logger logger = Logger.getLogger(MyJavaAdapterResource.class.getName());

    //Define the server api to be able to perform server operations
    WLServerAPI api = WLServerAPIProvider.getWLServerAPI();

	/* Path for method: "<server address>/Calc/adapters/MyJavaAdapter/users" */
	@GET
	...
	/* Path for method: "<server address>/Calc/adapters/MyJavaAdapter/users/{username}" */
	@GET
	@Path("/{username}")
	...
	/* Path for method: "<server address>/Calc/adapters/MyJavaAdapter/users/helloUserQuery?name=value" */
	@GET
	@Path("/helloUserQuery")
	...
	/* Path for method: "<server address>/Calc/adapters/MyJavaAdapter/users/prop" */
	@GET
	@Path("/prop")
	...
	/* Path for method: "<server address>/Calc/adapters/MyJavaAdapter/users/{first}/{middle}/{last}?age=value" */
	@POST
	...
	/* Path for method: "<server address>/Calc/adapters/MyJavaAdapter/users/newUsers" */
	@PUT
	@Path("/newUsers")
	...
	/* Path for method: "<server address>/Calc/adapters/MyJavaAdapter/users/helloUserBody" */
	@POST
