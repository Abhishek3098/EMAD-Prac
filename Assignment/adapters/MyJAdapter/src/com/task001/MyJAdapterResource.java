...
@Path("/users")
public class MyJAdapterResource {
	/*
	 * For more info on JAX-RS see https://jsr311.java.net/nonav/releases/1.1/index.html
	 */
		
	//Define logger (Standard java.util.Logger)
	static Logger logger = Logger.getLogger(MyJAdapterResource.class.getName());

    //Define the server api to be able to perform server operations
    WLServerAPI api = WLServerAPIProvider.getWLServerAPI();

	/* Path for method: "<server address>/Assignment/adapters/MyJAdapter/users" */
	@GET
	...
	/* Path for method: "<server address>/Assignment/adapters/MyJAdapter/users/{username}" */
	@GET
	@Path("/{username}")
	...
	/* Path for method: "<server address>/Assignment/adapters/MyJAdapter/users/helloUserQuery?name=value" */
	@GET
	@Path("/helloUserQuery")
	...
	/* Path for method: "<server address>/Assignment/adapters/MyJAdapter/users/prop" */
	@GET
	@Path("/prop")
	...
	/* Path for method: "<server address>/Assignment/adapters/MyJAdapter/users/{first}/{middle}/{last}?age=value" */
	@POST
	...
	/* Path for method: "<server address>/Assignment/adapters/MyJAdapter/users/newUsers" */
	@PUT
	@Path("/newUsers")
	...
	/* Path for method: "<server address>/Assignment/adapters/MyJAdapter/users/helloUserBody" */
	@POST
